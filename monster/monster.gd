...
onready var grab_area = $Origin/MonsterArmature/Skeleton/RightHandAnchor/GrabArea
onready var lstomp_area = $Origin/MonsterArmature/Skeleton/LeftFootAnchor/LStompArea
onready var rstomp_area = $Origin/MonsterArmature/Skeleton/RightFootAnchor/RStompArea
